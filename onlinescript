...
gg.alert(os.date("🇲🇲🇲🇲🇲🇲🇲🇲 LTNS KILLER MYANMAR SCRIPT Online Script V30 🇲🇲🇲🇲🇲🇲🇲🇲🇲🇲"))
gg.setVisible(false)
PUBGMH = 1
function HOME()
MN = gg.choice({ 
...
"{9📌} (AIM LOCK🔪🔪)",
"Ｅｘｉｔ"
}, nil,'✭❈ LTNS KILLER ❈\n࿇ script Version 👉 Online Script V30')
if MN == 1 then
Bypass()
end
if MN == 2 then
...
function Bypass()
  SN = gg.multiChoice({
"BYPASS {GL & KR} (No code) Lobby",
"BYPASS {KR} (New Code) Lobby",
"𝙴𝚇𝙸𝚃"},
nil,"🇲🇲LTNS Online Script V30🇲🇲")
  if SN == nil then
  else
  if SN[1] == true then
   me1()
...
WALL22 = gg.multiChoice({"✧ New Wallhack All Device","✧ Wallhack Fix Blink","✧ Wallhack Fix Scope","✧ Wallhack Exynos 7420","✧ Wallhack Exynos 7570","✧ New Wallhack Exynos 7870","✧ Wallhack Exynos 7880","✧ Wallhack Exynos 7885","✧ Wallhack Exynos 8890","✧ Wallhack Exynos 8895","✧ Wallhack Exynos 9610","✧ Wallhack Exynos 9810","✧ Wallhack Huawei","✧ Wallhack Kirin 650","✧ Wallhack Kirin 655","✧ Wallhack Kirin 658","✧ Wallhack Kirin 659","✧ Wallhack Kirin 710","✧ Wallhack Kirin 955","✧ Wallhack Kirin 970","✧ Wallhack Kirin 980","✧ New Wallhack Mediatek 6750","✧ Wallhack Mediatek 6765","✧ Wallhack Mediatek G90T","✧ New Wallhack Mediatek P10","✧ Wallhack Mediatek P22","✧ Wallhack Mediatek P23","✧ Wallhack Mediatek P35","✧ Wallhack Mediatek P60","✧ Wallhack Mediatek P65","✧ Wallhack Mediatek P70","✧ Wallhack Mediatek X20","✧ Wallhack Mediatek X25","✧ Wallhack Note 3","✧ Wallhack Oppo","✧ Wallhack Vivo","⎋BACK"}, nil, "🇲🇲🇲🇲LTNS V30")
if WALL22 == nil then
else
...
MN1 = gg.multiChoice({"{📌1}🔭🔭WH SD 400","{📌2}🔭🔭WH SD 410","{📌3}🔭🔭WH SD 415","{📌4}🔭🔭WH SD 425","{📌5}🔭🔭WH SD 430","{📌6}🔭🔭WH SD 435","{📌7}🔭🔭WH SD 439","{📌8}🔭🔭WH SD 450","{📌9}🔭🔭WH SD 600","{📌10}🔭🔭WH SD 610","{📌11}🔭🔭WH SD 615","{📌12}🔭🔭WH SD 616","{📌13}🔭🔭WH SD 625","{📌14}🔭🔭WH SD 626","{📌15}🔭🔭WH SD 630","{📌16}🔭🔭WH SD 632","{📌17}🔭🔭WH SD 636","{📌18}🔭🔭WH SD 650","{📌19}🔭🔭WH SD 652","{📌20}🔭🔭WH SD 653","{📌21}🔭🔭WH SD 660","{📌22}🔭🔭WH SD 665","{📌23}🔭🔭WH SD 670","{📌24}🔭🔭WH SD 675","{📌25}🔭🔭WH SD 710","{📌26}🔭🔭WH SD 712","{📌27}🔭🔭WH SD 800","{📌28}🔭🔭WH SD 801","{📌29}🔭🔭WH SD 805","{📌30}🔭🔭WH SD 808","{📌31}🔭🔭WH SD 810","{📌32}🔭🔭WH SD 815","{📌33}🔭🔭WH SD 820","{📌34}🔭🔭WH SD 821","{📌35}🔭🔭WH SD 835","{📌36}🔭🔭WH SD 845","{📌37}🔭🔭WH SD 855","[Back]"}, nil, "🇲🇲🇲🇲LTNS Online Script V30 VIP🇲🇲🇲🇲")
if MN1 == nil then
else
if MN1[1] == true then
WH400()
